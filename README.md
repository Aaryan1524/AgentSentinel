...
SQLite store, and a Python CLI. Adapter, notification-channel, and installer
PRs are next; no cloud account or provider token is needed for this core.
...
1. Claude Code and Gemini CLI adapters.
